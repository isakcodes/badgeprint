...
class Event(models.Model):
    ...
    logo = models.ImageField(
        upload_to=user_directory_path, verbose_name="Logo", null=True, blank=True
    )
    owner = models.ForeignKey(
        settings.AUTH_USER_MODEL, verbose_name="Event Owner", on_delete=models.PROTECT
    )
    label_tpl = models.CharField(
        verbose_name="Label Template", max_length=60, null=True, blank=True
    )
...
class Printer(models.Model):
    LABEL_CHOICES = (("62x29", "DK-11209 (62x29)"), ("62x100", "DK-11202 (62x100)"))
    location = models.CharField(
        verbose_name="Location", max_length=60, default="This Counter"
    )
    uri = models.CharField(verbose_name="URI", max_length=120)
    label = models.CharField(
        verbose_name="Label", max_length=20, default="62x29", choices=LABEL_CHOICES
    )
...
class PrinterUser(models.Model):
    ...
    printer = models.ForeignKey(
        Printer, verbose_name="Printer", on_delete=models.PROTECT
    )
    ticket_type = models.CharField(
        verbose_name="Label", max_length=60, null=True, blank=True
    )
...
class Participant(models.Model):
    ...
    company = models.CharField(
        verbose_name="Company Name", max_length=80, null=True, blank=True
    )
    ...
    ticket_type = models.CharField(
        verbose_name="Ticket Type", max_length=60, null=True, blank=True
    )
...
class Log(models.Model):
    event = models.ForeignKey(
        Event, verbose_name="Event", null=True, blank=True, on_delete=models.PROTECT
    )
    user = models.ForeignKey(
...
class Checkin(models.Model):
    event = models.CharField(
        verbose_name="Event ID", max_length=20, null=True, blank=True
    )
    attendee = models.CharField(
        verbose_name="Attendee ID", max_length=20, null=True, blank=True
    )
